...
struct TaxButtonView: View {
    ...
    var body: some View {
        ...
        .alert("Налоги и стаховка", isPresented: $showAlert) {
...
struct TaxButtonView_Previews: PreviewProvider {
    static var previews: some View {
            FuelButtonView(iconName: "dollarsign.arrow.circlepath")
